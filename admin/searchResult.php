...
<div class="d-flex flex-row justify-content-around">
  <?php
  $productData = new UseDataAdmin();
  $datas = $productData->searc();

        foreach($datas as $data)
      {
  ?>
  <ul class="list-group admin-read w-25">
    ...
    <li class="list-group-item d-flex justify-content-between">
      ...
      <button class="btn btn-success" type="submit" name="read" value="<?php print($data['product_id']); ?>">Show</button>
      </form>
      <form action="./updateAdminData.php" method="POST">
      <button class="btn btn-primary" type="submit" name="update" value="<?php print($data['product_id']); ?>">Update</button>
      </form>
      <form action="./deleteAdminData.php" method="POST">
      <button class="btn btn-danger" type="submit" name="delete" value="<?php print($data['product_id']); ?>">Delete</button>
      </form>
    </li>
  </ul>
...
<div class="back_to_admin  mt-3 w-50 ">
